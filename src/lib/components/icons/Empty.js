...
const useStyles = makeStyles((theme) => ({
  ...
  defaultEllipsePath2: {
    fill: `url('https://ant.design/index-d54851f4.css#linearGradient-1')`
  },
  defaultEllipsePath3: {
    fill: '#f5f5f7'
  },
...
export const Empty= () =>{
  ...
  return (
    <svg className="ant-empty-img-default" width="184" height="152" viewBox="0 0 184 152"
         xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd">
        <g transform="translate(24 31.67)">
          <ellipse className={classes.defaultEllipse} cx="67.797" cy="106.89" rx="67.797"
                   ry="12.668"></ellipse>
          <path className={classes.defaultEllipsePath1}
        ...
        <g className={classes.defaultEmptyImg} transform="translate(149.65 15.383)">
